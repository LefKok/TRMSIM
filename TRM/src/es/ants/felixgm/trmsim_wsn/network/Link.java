...
/**
 * <p>This class models a link between two nodes./p>
...
public class Link {
     ...
     */
    public Link(Sensor source, Sensor destination) 
    {
        this.source = source;
     ...
     * @return The source sensor of this link
     */
    public Sensor get_source() { return source; }

    /**
     * Retrives the destination sensor of this link
     * @return The destination sensor of this link
     */
    public Sensor get_destination() { return destination; }
}
