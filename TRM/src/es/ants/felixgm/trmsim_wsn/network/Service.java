 ...
 * or even an agent in a multi-agent system.</p>
 * <p>Currently it is defined only by its name or identifier, but it can be extended to
 * be defined by more characteristics such as the prize, the quality or the cost, for instance</p>
...
public class Service {
     ...
     * @param service Service to be compared
     * @return true if the given service is equal to this, false otherwise
     */
    public boolean equals(Service service) {
        return id.equalsIgnoreCase(service.id());
    }

    /**
     * This method creates and returns a copy of this service
     * @return A copy a this service
     */
    @Override
