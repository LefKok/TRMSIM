...
It provides one Trust and Reputation model called BTRM-WSN and new ones can be easily added.
...
TRMSim-WSN has been developed under jdk 1.6. and in order to be able to launch the simulator, the appropriate Java Virtual Machine must be installed on this computer.
